# WORKLOG TUẦN 1 - AWS INTERNSHIP

| **Thông tin** | **Chi tiết** |
|---------------|---------------|
| Thời gian | Tuần 1 (Ngày DD/MM/YYYY - DD/MM/YYYY) |
| Chủ đề | Getting Started với AWS Cloud |
...
| STT | Mục tiêu | Mô tả chi tiết | Trạng thái |
|-----|----------|----------------|-------------|
| 1 | Hoàn thành 5 nhiệm vụ | Nhận credit AWS để sử dụng các dịch vụ trong quá trình thực tập | Hoàn thành |
| 2 | Làm quen AWS Console | Thao tác thành thạo với giao diện quản lý AWS | Hoàn thành |
| 3 | Thiết lập theo dõi chi phí | Cấu hình Billing alerts & Budgets để tránh phát sinh chi phí ngoài ý muốn | Hoàn thành |
| 4 | Tạo EC2 instance | Tạo và quản lý máy chủ ảo đầu tiên trên AWS | Hoàn thành |
| 5 | Deploy web server | Triển khai một web server đơn giản chạy trên EC2 | Hoàn thành |
